      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Container>
          ...
          <View style={{ alignItems: "flex-start"}}>
            {selected === 1 ? 
            <SingleSelectCheck title="No activity - desk job with minimal movement" checked onPress={() => setSelected(1)}/> : 
            <SingleSelectCheck title="No activity - desk job with minimal movement" checked={false} onPress={() => setSelected(1)}/>
            }
            {selected === 2 ? 
            <SingleSelectCheck title="Moderate - requires some movement (realtor, teacher, pastor, sales, some stay at home moms)" checked onPress={() => setSelected(2)}/> : 
            ...
            {selected === 3 ? 
            <SingleSelectCheck title="Very active - requires physical activity (trainer, construction worker, stay at home mama with littles)" checked onPress={() => setSelected(3)}/> : 
            ...
            {selected === 4 ? 
            <SingleSelectCheck title="Extremely active - professional/collegiate athlete" checked onPress={() => setSelected(4)}/> : 
