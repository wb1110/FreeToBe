      ...
      <SafeAreaView style={{ flex: 1 }}>
        ...
        <Container>
          ...
          <View style={{ flexDirection: 'row' }}>
            {selected === 3 ? <RoundButtonSelected title="3" onPress={() => setSelected(3)}/> : <RoundButton title="3" onPress={() => setSelected(3)}/>}
            {selected === 4 ? <RoundButtonSelected title="4" type="clear" onPress={() => setSelected(4)}/> : <RoundButton title="4" onPress={() => setSelected(4)}/>}
            {selected === 7 ? <RoundButtonSelected title="7" type="clear" onPress={() => setSelected(7)}/> : <RoundButton title="7" onPress={() => setSelected(7)}/>}
            {selected === 9 ? <RoundButtonSelected title="9" type="clear" onPress={() => setSelected(9)}/> : <RoundButton title="9" onPress={() => setSelected(9)}/>}
          </View>
          <Text>
