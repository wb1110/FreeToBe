...
export default function NutritionFacts({
  ...
  useEffect(() => {
    setServingValues({
      ...
      calories: { value: calories.amount, unit: calories.unit },
      protein: { value: protein.amount, unit: protein.unit },
      carbs: { value: carbs.amount, unit: carbs.unit },
      fat: { value: fat.amount, unit: fat.unit },
